...
from replicado.utils import clean_string, data_mes
...
class Convenio:
    ...
    @staticmethod
    def listar_convenios_academicos_internacionais(ativos: bool = True) -> List[Dict[str, Any]]:
        """
        ...
        for convenio in convenios:
            ...
            convenio['dataInicio'] = data_mes(convenio['dataInicio']) if convenio['dataInicio'] else '—'
            convenio['dataFim'] = data_mes(convenio['dataFim']) if convenio['dataFim'] else '—'
