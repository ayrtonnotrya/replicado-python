...
class Pessoa:
    ...
    @staticmethod
    def dump(codpes: int, fields: List[str] = ['*']) -> Optional[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def cracha(codpes: int) -> Optional[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def email(codpes: int) -> Optional[str]:
        """
    ...
    def procurar_por_nome(
        ...
        fonetico: bool = True, 
        ativos: bool = True, 
        tipvin: Optional[str] = None, 
        codundclgs: Optional[str] = None, 
        tipvinext: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
        ...
        if codundclgs:
            additional_filters += f" AND L.codundclg IN ({codundclgs}) AND L.sitatl IN ('A', 'P')"
    ...
    @staticmethod
    def obter_nome(codpes: Union[int, List[int]]) -> Union[str, Dict[int, str], None]:
        """
    ...
    @staticmethod
    def obter_endereco(codpes: int) -> Optional[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def listar_vinculos_ativos(codpes: int, designados: bool = True) -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def listar_docentes(codset_list: Optional[str] = None, sitatl_list: str = 'A') -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def retornar_curso_por_codpes(codpes: int) -> Optional[Dict[str, Any]]:
        """
