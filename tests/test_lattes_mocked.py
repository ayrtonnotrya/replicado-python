...
class TestLattes(unittest.TestCase):
    ...
    def test_id(self, mock_fetch) -> None:
        mock_fetch.return_value = {"idfpescpq": "12345"}
        self.assertEqual(Lattes.id(123), "12345")

    @patch("replicado.connection.DB.fetch")
    def test_retornar_codpes(self, mock_fetch) -> None:
    ...
    def test_listar_premios(self, mock_array) -> None:
            ...
            "DADOS-GERAIS": {
                "PREMIOS-TITULOS": {
                    "PREMIO-TITULO": [
                        {
                            "@attributes": {
                                "NOME-DO-PREMIO-OU-TITULO": "Prêmio A",
                                "ANO-DA-PREMIACAO": "2020",
                            }
                        },
                        {
                            "@attributes": {
                                "NOME-DO-PREMIO-OU-TITULO": "Prêmio B",
                                "ANO-DA-PREMIACAO": "2021",
                            }
                        },
                    ]
                }
    ...
    @patch("replicado.lattes.Lattes.obter_array")
    def test_listar_artigos(self, mock_array) -> None:
        mock_array.return_value = {
                    ...
                    "ARTIGO-PUBLICADO": [
                        {
                            ...
                            "DETALHAMENTO-DO-ARTIGO": {
                                "@attributes": {
                                    "TITULO-DO-PERIODICO-OU-REVISTA": "Revista X"
                                }
                            },
                            "AUTORES": [
                                {
                                    "@attributes": {
                                        "NOME-COMPLETO-DO-AUTOR": "Autor 1",
                                        "ORDEM-DE-AUTORIA": "1",
                                    }
                                }
                            ],
    ...
    @patch("replicado.lattes.Lattes.obter_array")
    def test_retornar_resumo_cv(self, mock_array) -> None:
        mock_array.return_value = {
            "DADOS-GERAIS": {
                "RESUMO-CV": {
                    ...
                    "ATUACAO-PROFISSIONAL": {
                        "ATIVIDADES-DE-PESQUISA-E-DESENVOLVIMENTO": {
                            "PESQUISA-E-DESENVOLVIMENTO": {
                                "LINHA-DE-PESQUISA": {
                                    "@attributes": {
                                        "TITULO-DA-LINHA-DE-PESQUISA": "Linha 1"
                                    }
                                }
                            }
                        }
    ...
    def test_listar_capitulos_livros(self) -> None:
        mock_array = {
            "PRODUCAO-BIBLIOGRAFICA": {
                "LIVROS-E-CAPITULOS": {
                    "CAPITULOS-DE-LIVROS-PUBLICADOS": {
                        "CAPITULO-DE-LIVRO-PUBLICADO": {
                            ...
                            "DADOS-BASICOS-DO-CAPITULO": {
                                "@attributes": {
                                    "TITULO-DO-CAPITULO-DO-LIVRO": "CapITULO A",
                                    "ANO": "2023",
                                }
                            },
                            "DETALHAMENTO-DO-CAPITULO": {
                                "@attributes": {"TITULO-DO-LIVRO": "Livro A"}
                            },
                            "AUTORES": [
                                {
                                    "@attributes": {
                                        "NOME-COMPLETO-DO-AUTOR": "Autor A",
                                        "ORDEM-DE-AUTORIA": "1",
                                    }
                                }
                            ],
    ...
    def test_listar_trabalhos_anais(self) -> None:
        mock_array = {
            "PRODUCAO-BIBLIOGRAFICA": {
                "TRABALHOS-EM-EVENTOS": {
                    "TRABALHO-EM-EVENTOS": {
                        ...
                        "DADOS-BASICOS-DO-TRABALHO": {
                            "@attributes": {
                                "TITULO-DO-TRABALHO": "Trabalho A",
                                "ANO-DO-TRABALHO": "2023",
                            }
                        },
                        "DETALHAMENTO-DO-TRABALHO": {
                            "@attributes": {"NOME-DO-EVENTO": "Evento A"}
                        },
                        "AUTORES": [],
                    }
                }
    ...
    def test_listar_trabalhos_tecnicos(self) -> None:
        mock_array = {
            "PRODUCAO-TECNICA": {
                "TRABALHO-TECNICO": {
                    "@attributes": {"SEQUENCIA-PRODUCAO": "1"},
                    "DADOS-BASICOS-DO-TRABALHO-TECNICO": {
                        "@attributes": {
                            "TITULO-DO-TRABALHO-TECNICO": "Tecnico A",
                            "ANO": "2023",
                        }
                    },
                    "AUTORES": [],
    ...
    def test_listar_outras_producoes_bibliograficas(self) -> None:
        mock_array = {
            "PRODUCAO-BIBLIOGRAFICA": {
                "DEMAIS-TIPOS-DE-PRODUCAO-BIBLIOGRAFICA": {
                    "OUTRA-PRODUCAO-BIBLIOGRAFICA": {
                        ...
                        "DADOS-BASICOS-DE-OUTRA-PRODUCAO": {
                            "@attributes": {"TITULO": "Outra B", "ANO": "2023"}
                        },
                        "AUTORES": [],
                    },
                    "TRADUCAO": {
        ...
        res = Lattes.listar_outras_producoes_bibliograficas(
            123, lattes_array=mock_array
        )
    ...
    def test_listar_teses_e_livre_docencia(self) -> None:
        mock_array = {
            "DADOS-GERAIS": {
                "FORMACAO-ACADEMICA-TITULACAO": {
                    "DOUTORADO": {
                        "@attributes": {
                            "TITULO-DA-DISSERTACAO-TESE": "Tese DR",
                            "ANO-DE-OBTENCAO-DO-TITULO": "2023",
                        },
                        "PALAVRAS-CHAVE": {"@attributes": {"PALAVRA-CHAVE-1": "K1"}},
                    },
                    "LIVRE-DOCENCIA": {
                        "@attributes": {
                            "TITULO-DO-TRABALHO": "Tese LD",
                            "ANO-DE-OBTENCAO-DO-TITULO": "2022",
                        }
                    },
                }
            }
    ...
    def test_retornar_bancas(self) -> None:
        mock_array = {
